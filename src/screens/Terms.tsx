      ...
      <div className="pt-2">
        ...
        <div className="space-y-5 font-body text-[14px] leading-[1.55] text-ink-soft pb-10">
          <Section title="1. Who we are">
            Sorted is an Australian mobile-first payment service operated by Sorted Pty Ltd,
            Brisbane, Queensland. By using Sorted, you agree to these Terms.
          </Section>

          <Section title="2. Beta program">
            You are using a beta release of Sorted. Features may change, break, or be removed
            without notice. Money in the beta is simulated and has no real financial value.
          </Section>
          ...
          <Section title="6. Fees">
            Sorted does not charge a transaction fee on standard sends during the beta. Network fees
